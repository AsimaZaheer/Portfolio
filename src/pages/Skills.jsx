...
const Skills = () => {
  ...
  const frontendSkills = [
    { name: "HTML5", icon: "fab fa-html5", description: "Semantic and accessible markup for modern web pages." },
    { name: "CSS3", icon: "fab fa-css3-alt", description: "Styling and animations for beautiful interfaces." },
    { name: "JavaScript (ES6+)", icon: "fab fa-js", description: "Building interactive and dynamic web applications." },
    { name: "React.js", icon: "fab fa-react", description: "Creating reusable components and interactive UIs." },
    { name: "Tailwind CSS", icon: "fas fa-wind", description: "Rapidly designing custom and responsive layouts." },
  ];

  const tools = [
    { name: "Git", icon: "fab fa-git-alt", description: "Version control for collaborative development." },
    { name: "GitHub", icon: "fab fa-github", description: "Hosting and managing code repositories." },
    { name: "VS Code", icon: "fas fa-code", description: "Code editing with powerful extensions." },
    { name: "Figma", icon: "fas fa-vector-square", description: "Designing UI/UX layouts and prototypes." },
    { name: "Vite", icon: "fas fa-bolt", description: "Fast and optimized frontend tooling." },
  ];
  ...
  const certifications = [
    { name: "React JS Bootcamp", provider: "Udemy", logo: "fab fa-udemy" },
    { name: "Frontend Development", provider: "Coursera", logo: "fas fa-graduation-cap" },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow flex items-start">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold mb-1">React JS Bootcamp</h3>
              <p className="text-gray-600 mb-1">Udemy</p>
              <p className="text-gray-500 text-sm mb-3">Completed: 2023</p>
              <a
                href="#"
                target="_blank"
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow flex items-start">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold mb-1">Frontend Development Specialization</h3>
              <p className="text-gray-600 mb-1">Coursera</p>
              <p className="text-gray-500 text-sm mb-3">Completed: 2024</p>
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
